    ...
    <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-white fw-bolder my-1 fs-3">Carte Bancaire Virtuel</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
            @if(request()->user()->customer->cards()->where('type', 'VIRTUAL')->get()->count() <= request()->user()->customer->setting->nb_carte_virtual)
            <div class="d-flex">
                <button class="btn btn-bank" data-bs-toggle="modal" data-bs-target="#add-credit-card">Demander un nouvelle carte virtuel</button>
            </div>
            @endif
        </div>
        <!--end::Container-->
