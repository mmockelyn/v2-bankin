...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        <!--begin::Aside-->
        <div class="d-flex flex-column flex-lg-row-auto w-xl-900px positon-xl-relative" style="background-color: #F2C98A">
            <!--begin::Wrapper-->
        ...
        <div class="d-flex flex-column flex-lg-row-fluid py-10">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="form w-100" id="kt_sign_in_form" action="{{ route('auth.code.verify') }}" method="post">
                        @csrf
                        <!--begin::Heading-->
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">Code de Transaction (SECURPASS)</h1>
                            <!--end::Title-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="form-label fs-6 fw-bolder text-dark">Code</label>
                            <input type="hidden" name="uri_previous" value="{{ $uri_previous }}">
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-lg form-control-solid" type="password" name="auth_code" autocomplete="off" maxlength="4"/>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
