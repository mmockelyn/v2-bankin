...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('customer_insurance_autos', function (Blueprint $table) {
            $table->id();
            $table->string('reference');
            $table->enum('type', ["tiers", "plus", "all"]);
            $table->enum("type_vehicule", ["auto", "moto", "cyclo", "velo", "other"]);
    ...
    {
        Schema::dropIfExists('customer_insurance_autos');
    }
};
