...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('customer_insurance_securitas', function (Blueprint $table) {
            $table->id();
            $table->string('reference');
            $table->float('cotisation')->default(118.80);
    ...
    {
        Schema::dropIfExists('customer_insurance_securitas');
    }
};
